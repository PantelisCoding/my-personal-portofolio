  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center items-center lg:flex-row-reverse gap-9 lg:gap-15">
      ...
      <div className="text-center rounded-2xl p-7 font-mono z-10 px-4">
        <RevealOnScroll>
          <h1 className="text-4xl md:text-5xl lg:text-3xl lg:max-w-[500px] font-semibold mb-6 px-1 bg-gradient-to-r from-[#4285F4] via-[#DB4437] to-[#F4B400] bg-clip-text text-transparent">
            Hi I'm Pantelis
          </h1>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <p className="about-me text-white text-lg mb-8 max-w-lg mx-auto">
            I'm a web developer who loves creating interactive, scalable
